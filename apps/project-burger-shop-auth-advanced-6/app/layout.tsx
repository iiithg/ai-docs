          ...
          <div className="mx-auto max-w-5xl px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <nav className="text-sm text-neutral-600 flex gap-4">
                <Link href="/auth/login" className="hover:text-burger-red transition-colors">Auth</Link>
                <Link href="/protected" className="hover:text-burger-red transition-colors">Protected</Link>
              </nav>
            </div>
          </div>
        </header>
