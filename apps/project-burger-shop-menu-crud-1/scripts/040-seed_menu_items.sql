...
values
  ...
  ('Cheese Burger', 'Classic burger with double cheese slices', 'burger', 899, true, null),
  ...
  ('Salad', 'Fresh vegetable salad with dressing', 'side', 299, true, null),
  ('Cheese Fries', 'French fries with melted cheese sauce', 'side', 449, true, null),

  -- Drinks
  ('Cola', 'Classic Coca-Cola', 'drink', 199, true, null),
  ('Sprite', 'Refreshing lemon soda', 'drink', 199, true, null),
  ...
  ('Hot Tea', 'Premium tea leaves', 'drink', 199, true, null)
